...
SECRETKEY_MOMO = env("SECRETKEY_MOMO")
PARTNER_CODE_MOMO = env("PARTNER_CODE_MOMO")
ACCESS_KEY_MOMO = env("ACCESS_KEY_MOMO")
REDIRECT_URL_MOMO = env("REDIRECT_URL_MOMO")
IPN_URL_MOMO = env("IPN_URL_MOMO")
